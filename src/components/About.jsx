...
export default function About() {
    return (
        ...
        <div>
            ...
            <div className="container-fluid row fondo-card" style={{ backgroundColor: '#1d1d1f' }}>
            ...
            <CardColumns style={{ marginBottom: '30px' }}>
                ...
                <Card className="listado-card">
                    <Card.Body>
                        ...
                        <Card.Img
                            src="https://www.apple.com/v/environment/l/images/overview/energy_2__dhgalfc09byq_large_2x.jpg" alt="" />
                    </Card.Body>
                </Card>
            ...
            <div className="container-fluid row fondo-card" style={{ backgroundColor: '#e0def4' }}>
            ...
            <CardColumns style={{ marginBottom: '30px' }}>
                <Card className="listado-card" style={{ backgroundColor: '#1D1D1F' }}>
                    <Card.Body>
                        <Card.Title className="letra1-accesibilidad" >Hay un atajo para todo.</Card.Title>
                        <ReactPlayer
                            url='https://www.apple.com/105/media/us/privacy/2019/58349417-857c-47c2-89c3-6ab1a56a2f58/safari/medium_2x.mp4'
                            playing
                            controls
                            width='100%'
                            height='100%' />
                ...
                <Card bg="white" className="text-center p-3 listado-card">
                    <blockquote className="blockquote mb-0 card-body">
                        ...
                        <Card.Img variant="top" style={{ height: '128px' }} src="https://www.apple.com/v/accessibility/p/images/overview/facetime_sign_language__9o3n3z4dusii_large_2x.jpg" />
                    </blockquote>
                </Card>
            </CardColumns>
